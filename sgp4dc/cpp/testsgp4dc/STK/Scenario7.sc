...
Stop                    15 Mar 2008 19:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	1 Mar 2008 19:00:00.000000000
...
BEGIN Animation
    ...
    EndTime            15 Mar 2008 19:00:00.000000000
    CurrentTime        2 Mar 2008 09:15:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\dvallado\Documents\STK 10\Scenario7
            BaseName         Frame
            Digits           4
            Frame            0
...
END MapData
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	7 Nov 2014 19:00:00.000000000
				Stop	8 Nov 2014 19:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN References
    ...
    Instance Place/Place1
        Place/Place1
    END Instance
    Instance Satellite/OV1-5_02122
        Satellite/OV1-5_02122
    END Instance
    Instance Satellite/THOR_ABLESTAR_D_00552
        Satellite/THOR_ABLESTAR_D_00552
    END Instance
END References
